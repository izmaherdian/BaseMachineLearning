...
* 📁 **`images/`**: Contains extracted plots and visualizations from the notebook execution.

---

## ❓ Problems & Results Overview
Below is the systematic list of problems, tasks, and visual results implemented in the **[Program.ipynb](file:///run/media/izmaherdian/Windows-SSD/Izma_S2_InstrumentasiKontrol_ITB/Akademik/Project S1/BaseMachineLearning/Program.ipynb)** notebook:
...
* **The Results:**
  ...
  * **Visualizations:**
    ...
    | Training/Testing Loss | Decision Boundary Plots |
    | :---: | :---: |
    | <img src="images/iris_loss.png" width="350"/> | <img src="images/iris_decision_boundary.png" width="450"/> |

---

### **Problem 4: Binary Logistic Regression on Hand-written Digits (Digits Dataset)**
* **The Problem:** Classify hand-written digit images of `4` and `6` from the Scikit-learn Digits dataset using the JAX-based binary logistic regression classifier.
* **The Results:**
  * Trained the model on normalized $8 \times 8$ grayscale digit features.
  * **Evaluation Outcome:** The model achieved a **good baseline classification performance (Accuracy & Precision > 70%)**. Adjusting epochs and batch sizes can optimize this, but standard linear models might be sub-optimal for complex non-linear digit variations.
  * **Visualizations:**
    
    | Training/Testing Loss | Decision Boundary | Actual vs. Predicted Labels |
    | :---: | :---: | :---: |
    | <img src="images/digits_loss.png" width="300"/> | <img src="images/digits_decision_boundary.png" width="300"/> | <img src="images/digits_predictions.png" width="300"/> |
...
* **The Results:**
  ...
  * **Visualizations:**
    ...
    | Fashion MNIST Dataset Samples | MLP Model Predictions (Default) |
    | :---: | :---: |
    | <img src="images/fashion_mnist_samples.png" width="400"/> | <img src="images/fashion_mnist_mlp_default.png" width="400"/> |
...
* **The Results:**
  ...
  * **Visualizations:**
    ...
    | :---: |
    | <img src="images/fashion_mnist_cnn.png" width="450"/> |
...
* **The Results:**
  ...
  * **Visualizations:**
    ...
    | Synthetic Cluster Data | Standardized PCA Biplot | Unstandardized PCA Biplot |
    | :---: | :---: | :---: |
    | <img src="images/synthetic_clusters.png" width="300"/> | <img src="images/pca_standardized_biplot.png" width="300"/> | <img src="images/pca_unstandardized_biplot.png" width="300"/> |
...
* **The Results:**
  ...
  * **Visualizations:**
    ...
    | SVD Information Retained vs. Rank | Low Rank Approx ($r=10$) | Low Rank Approx ($r=60$) |
    | :---: | :---: | :---: |
    | <img src="images/svd_information_retained.png" width="300"/> | <img src="images/svd_rank_10_approx.png" width="300"/> | <img src="images/svd_rank_60_approx.png" width="300"/> |
